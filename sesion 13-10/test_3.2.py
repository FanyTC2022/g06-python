...
def funcionA(funcionB):
    ...
    def funcionC(*args, **kwargs):
        ...
        # args:nos permite recibir un número indetermindado de parametros por nuestra función
        # kwargs: nos permite recibir argumentos o parametros con keywords o claves
